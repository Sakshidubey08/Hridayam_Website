...
const Product1 = () => {
  ...
  const handleAddToCart = () => {
    ...
    setRemainingQuantity(prev => prev - quantity);
    navigate('/cart');
  };
  const [remainingQuantity, setRemainingQuantity] = useState(61);
  ...
  const product = {
    id: 'Product39',
    name: 'Decor fountains',
    price: '&#8377;1,200',
    images: {
      black: image31, // Replace with your actual image paths
      gray: nike3,
      red: nike2,
      ...
      <div className="product-detail">
        ...
        <div className="content">
          <div className='image2'>
            <img src={product.images[selectedColor]} alt="Product" className="product-image6" style={{ marginTop: '55px', marginLeft: '-32px' }} /></div>
