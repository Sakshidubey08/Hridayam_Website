...
const Product1 = () => {
  ...
  const product = {
    id: 'Product23',
    name: 'Double Canopy Umbrella',
    price: '&#8377;1,200',
    images: {
      black: image18, // Replace with your actual image paths
      gray: nike3,
      red: nike2,
      ...
      <div className="product-detail">
        ...
        <div className="content">
          <div className='image2'>
            <img src={product.images[selectedColor]} alt="Product" className="product-image6 h-4/2 "  /></div>
