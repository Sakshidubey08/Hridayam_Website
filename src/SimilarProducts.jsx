...
//     //     setProduct(data.data); // Assuming product details are in data.data
//     //     setLoading(false);
//     //   } catch (error) {
...
//     //                 const product = result.data.find(prod => prod._id === id);
...
//     // Find the selected product by ID, or use the first product as a fallback
//     const selectedProduct = data.data.find(prod => prod._id === id) || data.data[0];

//     // Set selected product and image
//     setSelectedProduct(selectedProduct);
//     setSelectedImage(selectedProduct?.image); // Set the main image from the selected product

//     setLoading(false); // Stop loading once the data is fetched
// } catch (error) {
//     // Handle error: set error message and stop loading
//     setError(error.message);
//     setLoading(false);
// }
// };
...
useEffect(() => {
    const fetchProductDetails = async () => {
        try {
            ...
            // Check if data and data.data exist and handle accordingly
            if (data && data.data) {
                const product = data.data;
                setProduct(data.data); // Set the entire data if needed
